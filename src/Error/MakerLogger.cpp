...
// Version     : 2.4
// Description : Implementation of the MakerLogger class for logging in the VoronoiMeshMaker library.
//               Part of the 'error' group for robust error management.
//
// This program is free software: you can redistribute it and/or modify it
// under the terms of the GNU General Public License as published by the
// Free Software Foundation, version 3 of the License, or (at your option) any later version.
//
 ...
 * @brief Implements the MakerLogger class, which provides logging functionalities for the VoronoiMeshMaker library.
 *
 * This file contains the implementation of the methods of the MakerLogger class, which are used to record
 * important messages, warnings, and errors, helping to track program flow.
 *
 * @ingroup error
 * @version 2.4
 * @date 2024
...
//#include <boost/log/utility/setup/file.hpp> // Uncomment if file logging is needed
...
void MakerLogger::addBreadcrumb(std::string_view message, const std::source_location& location) {
...
void MakerLogger::error(std::string_view message, const std::source_location& location) {
